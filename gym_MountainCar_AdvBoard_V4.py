...
# TESTING
    if episode % test_period == 0:
        ...
        try:
            with open(r'gym_MountainCar_AdvBTraining_AdvBoard_0995_10Adv_V1.txt', 'w') as fp:
                fp.write('\n'.join(str(item) for item in total_reward_list))
            with open(r'gym_MountainCar_AdvBTraining_TrainingNet_0995_10Adv_V1.txt', 'w') as fp:
                fp.write('\n'.join(str(item) for item in total_reward_test_list))
            with open(r'gym_MountainCar_AdvBTraining_Cooperative_0995_10Adv_V1.txt', 'w') as fp:
        ...
        try:
            if episode % 10 == 0:
                with open(r'gym_MountainCar_AdvBoard_wins.txt', 'w') as fp:
                    fp.write('\n'.join(str(item) for item in dqn_performance_wins_list))
                with open(r'gym_MountainCar_AdvBoard_trials.txt', 'w') as fp:
...
q_network.save('gym_MountainCar_AdvB10_q_network.h5')
with open(r'gym_MountainCar_AdvB_10_weights.txt', 'w') as fp:
